...
public class Anonymizer {
    ...
    public AnonymizationResult anonymize(String text) {
        if (text == null || text.isEmpty()) {
            return new AnonymizationResult("", "", new ArrayList<>(), anonymizerStrategy.getStrategyName(), locale);
        }
        ...
        return new AnonymizationResult(text, anonymizedText, allEntities, anonymizerStrategy.getStrategyName(), locale);
    }
