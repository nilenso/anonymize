...
public class PIIEntity {
    ...
    public PIIEntity(PIIType type, int startPosition, int endPosition, String text, double confidence) {
        this.type = type;
    ...
    /**
     * Creates a PIIEntity from a string type value.
     * This is a convenience constructor that handles the conversion from String to PIIType.
     *
     ...
     */
    public PIIEntity(String typeValue, int startPosition, int endPosition, String text, double confidence) {
