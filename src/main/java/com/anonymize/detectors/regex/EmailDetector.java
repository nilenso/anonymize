...
/**
 * Detector for email addresses using regex pattern matching. Email format is generally consistent
 * across locales, so this detector supports all locales.
 */
public class EmailDetector extends BaseRegexDetector {
  ...
  private static final String DEFAULT_EMAIL_PATTERN =
  ...
  /**
   * Specialized confidence calculation method for email addresses. Could be enhanced to provide
   * higher confidence for specific domain types, etc.
   */
  @Override
