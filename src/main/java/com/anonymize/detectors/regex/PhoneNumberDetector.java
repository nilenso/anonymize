...
/**
 * Detector for phone numbers using regex pattern matching. Supports multiple locales with different
 * phone formats.
 */
public class PhoneNumberDetector extends BaseRegexDetector {
  ...
  /**
   * Specialized confidence calculation for phone numbers. Could be enhanced to provide different
   * confidence levels for different formats.
   */
  @Override
