...
/**
 * Base class for all DJL-based detectors, providing common functionality for loading models and
 * processing text.
 */
public abstract class BaseDJLDetector extends AbstractDetector {
  ...
  /**
   * Initialize the model predictor. This method must be implemented by subclasses to create the
   * appropriate predictor for the specific model type.
   *
