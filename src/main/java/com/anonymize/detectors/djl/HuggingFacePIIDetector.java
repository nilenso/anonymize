...
public class HuggingFacePIIDetector extends BaseDJLDetector {
  ...
  //     @Override
  //     public NamedEntity[] processOutput(TranslatorContext ctx, NDList list) throws
  // TranslateException {
  //         try {
  ...
  // encoding.getClass().getDeclaredField("text");
  ...
  //                 }
  //             } catch (Exception e) {
  //                 logger.warn("Could not access original text from encoding: {}",
  // e.getMessage());
  ...
  //                             results.add(buildEntity(currentType, currentText.toString().trim(),
  // , startChar, endChar));
  //                         }
  ...
  //                     if (currentType != null) {
  //                         if (startChar >= 0 && endChar > startChar) {
  //                             results.add(buildEntity(currentText.toString().trim(), currentType,
  // 1,startChar, endChar));
  //                         }
  //                         currentText.setLength(0);
  //                         currentType = null;
  ...
  //             if (currentType != null && currentText.length() > 0 && startChar >= 0 && endChar >
  // startChar) {
  //                 results.add(buildEntity(currentText.toString().trim(), currentType, startChar,
  // endChar));
  //             }
