...
/**
 * Base class for all detectors that use Named Entity Recognition (NER) models to identify PII
 * entities. This provides a foundation for implementing machine learning-based detection
 * capabilities.
 */
public abstract class BaseNERDetector extends AbstractDetector {
  ...
  /**
   * Loads the ML model for the current locale. Implementations should load the appropriate model
   * based on the locale.
   */
  protected abstract void loadModel();

  /**
   * Gets the confidence threshold for this detector. Entities with confidence below this threshold
