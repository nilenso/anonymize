...
/**
 * Tests for the HuggingFacePIIDetector class. These tests are enabled only when the models
 * directory exists.
 */
public class HuggingFacePIIDetectorTest {
  ...
  public void testPersonDetection() {
    ...
    try {
      ...
      boolean foundPerson = entities.stream().anyMatch(e -> e.getType() == PIIType.PERSON_NAME);
  ...
  public void testEntityTypeMapping() {
    ...
    try {
      ...
      assertEquals(
          PIIType.PERSON_NAME, detector.mapEntityType("B-PER"), "PER should map to PERSON");
      assertEquals(
          PIIType.ORGANIZATION, detector.mapEntityType("I-ORG"), "ORG should map to ORGANIZATION");
      ...
      assertEquals(
          PIIType.MISC, detector.mapEntityType("UNKNOWN"), "Unknown type should map to MISC");
    } finally {
      detector.close();
    }
  }
  ...
  public void testLocationDetection() {
    ...
    try {
      ...
      String text =
          "The meeting will take place in San Francisco, California, not too far from Seattle.";
      ...
      boolean foundLocation = entities.stream().anyMatch(e -> e.getType().equals(PIIType.LOCATION));
  ...
  public void testConstructorAndParameters() {
    ...
    try {
      ...
      assertTrue(
          detector.getSupportedLocales().contains(Locale.GENERIC),
  ...
  public void testMixedEntityDetection() {
    ...
    try {
      ...
      String text =
          "Sarah Johnson is traveling to London next month for a conference at Microsoft headquarters.";
  ...
  //         assertEquals(0.95, entities.get(0).getConfidence(), 0.01, "Confidence should be
  // preserved");
  //     } finally {
  //         detector.close();
  //     }
  ...
  public void testProcessNamedEntitiesWithMultiTokens() {
    ...
    NamedEntity[] mockEntities =
        new ai.djl.modality.nlp.translator.NamedEntity[] {
  ...
  private ai.djl.modality.nlp.translator.NamedEntity createNamedEntity(
    ...
    return new ai.djl.modality.nlp.translator.NamedEntity(entityType, score, 0, word, start, end);
  }
}
