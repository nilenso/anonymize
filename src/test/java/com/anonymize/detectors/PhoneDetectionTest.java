...
public class PhoneDetectionTest {
    ...
    public void setup() {
        ...
        List<String> testPatterns = Arrays.asList(
    ...
    public void testBasicPhoneDetection() {
        ...
        if (!result.getDetectedEntities().isEmpty()) {
            ...
            assertTrue(entity.getText().replaceAll("[^0-9]", "").length() >= 7,
    ...
    public void testMultiplePhoneFormats() {
        ...
        assertTrue(result.getDetectedEntities().size() > 0, 
                 "Should detect at least one phone number format");
    ...
    public void testDetectorPatterns() {
        ...
        assertTrue(matchedPatterns > 0, 
                 "Detector should recognize at least one valid phone format");
    }
}