...
public class RemoveAnonymizerTest {
    ...
    public void setup() {
        ...
        removeAnonymizer = new Anonymizer.Builder()
    ...
    public void testBasicRemoval() {
        ...
        assertFalse(result.getAnonymizedText().contains("user@example.com"),
    ...
    public void testRemovingMultipleEntities() {
        ...
        // Verify PII was removed completely
        assertFalse(result.getAnonymizedText().contains("info@example.com"),
    ...
    public void testRemovingPreservesContext() {
        ...
        assertTrue(result.getAnonymizedText().startsWith("This is an email address: "),
                 "Text before email should be preserved");
        assertTrue(result.getAnonymizedText().endsWith(" and some more text."),
    ...
    public void testRemovingInSentence() {
        ...
        assertFalse(result.getAnonymizedText().contains("support@company.com"),
                  "Email should be removed");
                  
        // Verify sentence structure
        assertTrue(result.getAnonymizedText().contains("email  today"),
